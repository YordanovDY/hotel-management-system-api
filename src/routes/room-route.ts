...
import { addRoomController, deleteRoomController, getRoomController, getRoomsController, updateRoomController } from "../controllers/room-controller";
...
roomRouter.put('/:id', requireToken, requireAdminPermissions, updateRoomController);
